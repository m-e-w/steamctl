...
4. Download the binary  
    ```bash
    curl -L "https://github.com/m-e-w/steamctl/releases/download/v0.1.2/steamctl-linux-amd64" -o steamctl
    ```
    Release: https://github.com/m-e-w/steamctl/releases/tag/v0.1.2
5. Verify checksum
    ```bash
    sha256sum steamctl
    ```
